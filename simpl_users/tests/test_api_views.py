...
class UserTestCase(APITestCase, TestCase):
    ...
    def test_user_delete(self):
        url = reverse('simpl_users_api:user-detail', kwargs={'email': self.new_user.email})
    ...
    def test_user_detail(self):
        url = reverse('simpl_users_api:user-detail', kwargs={'email': self.user.email})
    ...
    def test_user_update(self):
        obj = self.user
        url = reverse('simpl_users_api:user-detail', kwargs={'email': obj.email})
